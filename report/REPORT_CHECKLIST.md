...
| Optional W&B experiment dashboard | Appendix E and `docs/wandb_logging.md` | `mpot/wandb_logger.py`, `scripts/run_serial.py`, `scripts/run_mpi.py`, `scripts/log_run_to_wandb.py` | Optional W&B run plus local `results/<run_id>/wandb_manifest.json`; local artifacts remain source of truth | Implemented |
